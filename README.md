...
> [!NOTE]  
> Sequoia requires OCLP 2.0.0, and an internet connection, either via USB tethering or ethernet.
<div align="center">
...
This OpenCore configuration is made of multiple external applications from different people and organizations. [See each program for their licensing](src/REFERENCE.md).
