...
[![macOS](https://img.shields.io/badge/macOS-Sonoma-green.svg?logo=apple)](https://github.com/acidanthera/OpenCorePkg)
...
Apply root-patches using Opencore Legacy Patcher to restore WiFi functionality since Monterey, and Graphics Acceleration since Ventura. 
...
This OC configuration has lifted some security settings, necessary for root patching.  You can leave this config as-is or re-enable them by:
